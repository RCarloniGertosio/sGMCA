...
- ![equation](https://latex.codecogs.com/svg.latex?\mathbf{N}%20\in%20\mathbb{R}^{m%20\times%20p}) is a Gaussian, independant and identically distributed noise.
...
Perform a sBSS on the data `X` with four sources, three of which having a spectrum modelled with a IAE.
